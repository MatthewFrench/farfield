...
export const APP_SERVER_CLIENT_RESPONSE_CONTEXTS = {
  ...
  fuzzyFileSearchSessionStart: "AppServerFuzzyFileSearchSessionStartResponse",
  fuzzyFileSearchSessionUpdate: "AppServerFuzzyFileSearchSessionUpdateResponse",
  fuzzyFileSearchSessionStop: "AppServerFuzzyFileSearchSessionStopResponse",
