      ...
      inputModalities: z
        .array(
          z
            ...
            .superRefine((x, ctx) => {
              const schemas = [
                z.literal("text").describe("Plain text turns and tool payloads."),
                z.literal("image").describe("Image attachments included in user turns."),
              ];
            ...
            .describe("Canonical user-input modality tags advertised by a model."),
        )
        .default(["text", "image"]),
      isDefault: z.boolean(),
      model: z.string(),
