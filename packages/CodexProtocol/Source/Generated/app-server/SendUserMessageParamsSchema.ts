                ...
                z.object({
                  byteRange: z
                    .object({
                        ...
                        .int()
                        .gte(0)
                        .describe("End byte offset (exclusive) within the UTF-8 text buffer."),
                      start: z
                        .number()
                        .int()
                        .gte(0)
                        .describe("Start byte offset (inclusive) within the UTF-8 text buffer."),
                    })
                    .describe("Byte range in the parent `text` buffer that this element occupies."),
                  placeholder: z
                    .union([
                      z
                        .string()
