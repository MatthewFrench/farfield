...
const RUNTIME_NOTIFICATION_PROJECTION_METHODS = new Set([
  ...
  TURN_STARTED_NOTIFICATION_METHOD,
  TURN_COMPLETED_NOTIFICATION_METHOD,
  TURN_PLAN_UPDATED_NOTIFICATION_METHOD,
  TURN_DIFF_UPDATED_NOTIFICATION_METHOD,
  THREAD_TOKEN_USAGE_UPDATED_NOTIFICATION_METHOD,
  THREAD_REALTIME_STARTED_NOTIFICATION_METHOD,
  THREAD_REALTIME_CLOSED_NOTIFICATION_METHOD,
  THREAD_REALTIME_ERROR_NOTIFICATION_METHOD,
  THREAD_ARCHIVED_NOTIFICATION_METHOD,
