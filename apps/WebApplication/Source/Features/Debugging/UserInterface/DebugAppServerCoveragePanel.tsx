...
interface ConfigValueWriteSectionProps {
  isRunningCoverageAction: boolean;
  configWriteKeyPath: string;
  setConfigWriteKeyPath: (nextValue: string) => void;
  configWriteValue: string;
  setConfigWriteValue: (nextValue: string) => void;
  configWriteMergeStrategy: "replace" | "upsert";
  setConfigWriteMergeStrategy: (nextValue: "replace" | "upsert") => void;
  configWriteFilePath: string;
  setConfigWriteFilePath: (nextValue: string) => void;
  configWriteExpectedVersion: string;
  setConfigWriteExpectedVersion: (nextValue: string) => void;
  lastConfigValueWriteResult: DebugAppServerCoverageConfigValueWriteResult | null;
  onRun: () => void;
}

function ConfigValueWriteSection({
  isRunningCoverageAction,
  configWriteKeyPath,
  setConfigWriteKeyPath,
  configWriteValue,
  setConfigWriteValue,
  configWriteMergeStrategy,
  setConfigWriteMergeStrategy,
  configWriteFilePath,
  setConfigWriteFilePath,
  configWriteExpectedVersion,
  setConfigWriteExpectedVersion,
  lastConfigValueWriteResult,
  onRun,
}: ConfigValueWriteSectionProps): React.JSX.Element {
  return (
    ...
    <div data-testid="debug-coverage-panel" className="flex-1 min-h-0 overflow-auto p-4 space-y-3">
      ...
      {coverageDiagnosticsSnapshot !== null && (
        <>
          ...
          <ConfigValueWriteSection
            isRunningCoverageAction={isRunningCoverageAction}
            configWriteKeyPath={configWriteKeyPath}
            setConfigWriteKeyPath={setConfigWriteKeyPath}
            configWriteValue={configWriteValue}
            setConfigWriteValue={setConfigWriteValue}
            configWriteMergeStrategy={configWriteMergeStrategy}
            setConfigWriteMergeStrategy={setConfigWriteMergeStrategy}
            configWriteFilePath={configWriteFilePath}
            setConfigWriteFilePath={setConfigWriteFilePath}
            configWriteExpectedVersion={configWriteExpectedVersion}
            setConfigWriteExpectedVersion={setConfigWriteExpectedVersion}
            lastConfigValueWriteResult={lastConfigValueWriteResult}
            onRun={runCoverageConfigWrite}
          />
